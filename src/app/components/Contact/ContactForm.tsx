...
const ContactForm = () => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    const response = await toast.promise(
      ...
      // Three possible states of the promise, these will update from pending to success(or error)
      {
    ...
    // SUCCESSFUL RESPONSE, RESETS THE FORM
    if (response.ok) {
      setLoading(false);
      ...
      // ROUTE USER BACK TO THE TOP OF THE APP
      // const router = useRouter();
      // router.push("#");
    }
  ...
  return (
    ...
    ${
      ...
      {/* Displays toast when user submits the completed contact form */}
      <Toast />
    </>
  );
};
