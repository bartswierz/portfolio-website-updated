...
const ContactForm = () => {
  ...
  return (
    <form
      ...
      className="border-[3px] border-white max-w-[550px] w-full bg-primary p-4 rounded-lg my-8 mx-4  animate-jump-in animate-once animate-duration-[800ms] animate-delay-500"
    >
